...
namespace FourSquare.SharpSquare.Entities
{
    public class Special : FourSquareEntity
    {
        ...
        ///     in progress -> the special is locked but could be unlocked if you check in (flash specials), or the special is
        ///     locked but could be unlocked if enough of your friends check in (friends specials)
        ...
        /// <summary>
        ///     A description of how close you are to unlocking the special. Either the number of people who have already unlocked
        ///     the special (flash and swarm specials), or the number of your friends who have already checked in (friends
        ///     specials)
        /// </summary>
