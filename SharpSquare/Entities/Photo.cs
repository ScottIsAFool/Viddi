namespace FourSquare.SharpSquare.Entities
{
    public class Photo : FourSquareEntity
    {
        ...
        ///     - capXX: cap the photo with a width or height of XX (whichever is larger). Scales the other, smaller dimension
        ///     proportionally
        ...
        /// <summary>
        ///     The count of supported sizes, plus items, an array of supported sizes. Each size will have a string url and integer
        ///     width and height parameters. The first item will be the original photo size, and the remaining items will be
        ///     derived photo sizes. Just because a derived photo size (with url) is returned does not mean it is necessarily
