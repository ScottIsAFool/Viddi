...
namespace FourSquare.SharpSquare.Entities
{
    public class Category : FourSquareEntity
    {
        ...
        ///     Combine prefix with a size (32, 44, 64, and 88 are available) and suffix, e.g.
        ///     https://foursquare.com/img/categories/food/default_64.png.
        ///     To get an image with a gray background, use bg_ before the size, e.g.
        ...
        /// <summary>
        ///     (only present in venues/categories response). A list of categories that are descendants of this category in the
        ///     hierarchy.
        /// </summary>
