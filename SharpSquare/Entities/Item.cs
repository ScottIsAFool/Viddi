...
namespace FourSquare.SharpSquare.Entities
{
    public class Item : FourSquareEntity
    {
        ...
        /// <summary>
        ///     The compact user who added this item to the current list. Only present when viewing a specific list and when the
        ///     user is the not same as the list owner.
        /// </summary>
        public User user { get; set; }

        /// <summary>
        ///     A photo for this item. If no photo has been explicitly set on this item, but the tip contains a photo it will be
