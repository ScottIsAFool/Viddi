...
namespace FourSquare.SharpSquare.Entities
{
    public class Venue : FourSquareEntity
    {
        ...
        /// <summary>
        ///     An object containing none, some, or all of address (street address), crossStreet, city, state, postalCode, country,
        ///     lat, lng, and distance. All fields are strings, except for lat, lng, and distance. Distance is measured in meters.
        ///     Some venues have their locations intentionally hidden for privacy reasons (such as private residences). If this is
        ///     the case, the parameter isFuzzed will be set to true, and the lat/lng parameters will have reduced precision.
        /// </summary>
        public Location location { get; set; }

        /// <summary>
        ///     An array, possibly empty, of categories that have been applied to this venue. One of the categories will have a
        ///     field primary indicating that it is the primary category for the venue. For the complete set of categories, see
        ///     venues/categories.
        /// </summary>
        ...
        /// <summary>
        ///     Contains the hours during the week that the venue is open along with any named hours segments in a human-readable
        ///     format. For machine readable hours see venues/hours
        /// </summary>
        public Hour hours { get; set; }

        /// <summary>
        ///     Optional Contains the hours during the week when people usually go to the venue. For machine readable hours see
        ///     venues/hours.
        /// </summary>
        ...
        /// <summary>
        ///     An object containing the price tier from 1 (least pricey) - 4 (most pricey) and a message describing the price
        ///     tier.
        /// </summary>
        public Price price { get; set; }

        /// <summary>
        ///     If v >= 20120121, a dictionary containing count and items array of specials at this venue. Otherwise, an array,
        ///     possibly empty, of specials at this venue.
        /// </summary>
        public FourSquareEntityItems<Special> specials { get; set; }

        /// <summary>
        ///     Optional. Information about who is here now. If present, there is always a count, the number of people here. If
        ///     viewing details and there is a logged-in user, there is also a groups field with friends and others as types.
        /// </summary>
        ...
        /// <summary>
        ///     user is the compact user who is the mayor (absent if there is no mayor), and count is the number of times they have
        ///     checked in within the last 60 days.
        /// </summary>
        ...
        /// <summary>
        ///     A grouped response of lists that contain this venue. Contains a summary string representing the acting user's
        ///     relationship to these lists. If an acting user is present, groups may include todos, created, edited, followed,
        ///     friends, and others. If this venue is on the acting user's todo list, those items will be included in the todos
        ///     group.
        /// </summary>
        ...
        /// <summary>
        ///     Present if and only if the current user has at least one assigned role for this venue. The value is a list of all
        ///     of the current user's assigned roles for this venue. Possible values for each element of the list are manager and
        ///     employee. Subject to change as additional roles may be defined.
        /// </summary>
