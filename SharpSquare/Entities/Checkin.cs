namespace FourSquare.SharpSquare.Entities
{
    public class Checkin : FourSquareEntity
    {
        ...
        /// <summary>
        ///     optionalIf the type of this checkin is shout or venueless, this field may be present and may contains a lat, lng
        ///     pair and/or a name, providing unstructured information about the user's current location.
        /// </summary>
